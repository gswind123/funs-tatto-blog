...
;(function (root, factory) {
    ...
    function Swipe(container, options) {
        ...
        const orientationId = options.orientation === 'horizontal' ? 1:2;
        ...
        function setup() {
            ...
            element.style.width = (slides.length * getBoundAmount() * 2) + 'px';
            ...
            while(pos--) {
                ...
                slide.style.width = getBoundAmount() + 'px';
                slide.setAttribute('data-index', pos);

                if (browser.transitions) {
                    slide.style.left = (pos * -getBoundAmount()) + 'px';
            ...
            if (!browser.transitions) {
                element.style.left = (index * -getBoundAmount()) + 'px';
            }
